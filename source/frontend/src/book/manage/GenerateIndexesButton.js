...
const GenerateIndexesButton = ({onClickGenerateButton, defaultQuery, ...props}) => {
  ...
  return (
    ...
    <Dialog open={isDialogOpend} onClose={()=>{setIsDialogOpend(false);}}>
      <DialogTitle sx={{color: "black", fontWeight: "bolder", fontFamily: "BMDfont"}}>목차 생성</DialogTitle>
      <DialogContent>
        <Stack>
            <StyledTextField
                name="query"
...
export default GenerateIndexesButton;